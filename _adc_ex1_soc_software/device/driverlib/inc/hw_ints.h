...
#define INT_CANA_1                  0x00640905U // 9.5 - CANA Interrupt 1
#define INT_CANA_2                  0x00650906U // 9.6 - CANA Interrupt 2
#define INT_CANB_1                  0x00660907U // 9.7 - CANB Interrupt 1
#define INT_CANB_2                  0x00670908U // 9.8 - CANB Interrupt 2
...
// Upper PIE Group 1
#define INT_IPC1                    0x0084010DU // 1.13 - IPC Interrupt 1
#define INT_IPC2                    0x0085010EU // 1.14 - IPC Interrupt 2
#define INT_IPC3                    0x0086010FU // 1.15 - IPC Interrupt 3
#define INT_IPC4                    0x00870110U // 1.16 - IPC Interrupt 4
