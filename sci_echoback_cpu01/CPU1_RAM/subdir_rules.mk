...
Example_2837xDSci_Echoback.obj: /opt/ti/c2000ware/device_support/f2837xd/examples/cpu1/sci_echoback/cpu01/Example_2837xDSci_Echoback.c $(GEN_OPTS) | $(GEN_HDRS)
	@echo 'Building file: $<'
	@echo 'Invoking: C2000 Compiler'
	"/opt/ti/ccsv7/tools/compiler/ti-cgt-c2000_16.9.1.LTS/bin/cl2000" -v28 -ml -mt --vcu_support=vcu2 --cla_support=cla1 --float_support=fpu32 --tmu_support=tmu0 --include_path="/opt/ti/ccsv7/tools/compiler/ti-cgt-c2000_16.9.1.LTS/include" --include_path="/opt/ti/c2000ware/device_support/f2837xd/headers/include" --include_path="/opt/ti/c2000ware/device_support/f2837xd/common/include" -g --define=CPU1 --display_error_number --diag_warning=225 --diag_suppress=10063 --preproc_with_compile --preproc_dependency="Example_2837xDSci_Echoback.d" $(GEN_OPTS__FLAG) "$(shell echo $<)"
