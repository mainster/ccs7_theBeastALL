...
SECTIONS
{
	...
	/* RAML4 for all program sections */
   	...
   	.cinit   		: > RAML4L,  	PAGE = 0				/* initialised variables */
 	...
 	.ebss    		: > RAML4H,		PAGE = 1			/* far variables [RAMM0] */
					RUN_START(_ebss_start),
					RUN_SIZE(_ebss_size)

 	.econst  		: > RAML4H,		PAGE = 1			/* far constants [RAMM0] */
 	.esysmem 		: > RAML4H,	 	PAGE = 1			/* far dynamic memory [RAMM0] */
